...
public class FoodsFragment extends InputPaneFragment {
    public static final String TAG = FoodsFragment.class.getSimpleName();
...
//    private List<String> buttonTitleFoods = Menu.createListOfButtonTitleFoods();
    ...
    public static FoodsFragment newInstance(int param1, int param2) {
